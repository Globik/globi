...
<body>
${(warnig ? `<div id="warnig">Warnig</div>`:``)}<nav class="back">${header_menu.header_menu({buser:n.buser})}</nav>
...
<span>Wingdings :</span><span style="font-family:Wingdings ;">Hello World!</span><br>
